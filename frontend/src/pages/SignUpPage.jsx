      ...
      <div className="border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className='text-sm opacity-70'>
                      Connect. Converse. Become fluent.
                    </p>
                  </div>
                  ...
                  <div className='space-y-3'>
                    ...
                    <div className='form-control w-full'>
                      ...
                      <input type="email" placeholder='example@domain.com' className="input input-bordered w-full" value={signupData.email} onChange={(e)=> setSignupData({...signupData, email: e.target.value})} required>
                      </input>
                    </div>
                    ...
                    <div className='form-control w-full'>
                      ...
                      <p className='test-xs opacity-70 mt-1'>
                    ...
                    <div className='form-control'>
                      <label className='label cursor-pointer justify-start gap-2'>
                       <input type='checkbox' className='checkbox checkbox-sm' required></input>
        ...
        <div className='max-w-md p-8'>
          ...
          <div className='relative aspect-square max-w-sm mx-auto'>
            <img src='/vc.png' alt="Language connection illustration" className='w-full h-full'></img>
          </div>
