...
const NotificationsPage = () => {
  ...
  const {data: friendRequests, isLoading} = useQuery({
    queryKey: ["friendRequests"], // Fixed: Made plural for consistency
  ...
  const {mutate: acceptRequestMutation, isPending} = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ["friendRequests"]}); // Fixed: Made plural
      queryClient.invalidateQueries({queryKey: ["friends"]});
    },
  });
  
  const incomingRequests = friendRequests?.incomingRequs || [];
